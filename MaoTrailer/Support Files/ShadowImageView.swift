...
public class ShadowImageView: UIView {
  ...
  private var gr: CAGradientLayer!
  ...
  private func layoutImageView() {
    ...
    if self.gradient {
      gr = CAGradientLayer()
      gr.frame = imageView.bounds
      gr.colors = [UIColor.clear.cgColor, UIColor.black.cgColor]
      gr.locations = [0.7, 0.9]
      imageView.layer.mask = gr
      imageView.layer.addSublayer(gr)
